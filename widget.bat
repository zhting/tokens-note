...
if exist "%UserProfile%\miniconda3\python.exe" (
    "%UserProfile%\miniconda3\python.exe" -c "import tkinter" >nul 2>&1
...
if exist "%UserProfile%\anaconda3\python.exe" (
    "%UserProfile%\anaconda3\python.exe" -c "import tkinter" >nul 2>&1
...
for /f "delims=" %%I in ('py -3 -c "import sys,tkinter; print(sys.executable)" 2^>nul') do set "PYEXE=%%I"
...
echo The first python on PATH is often ESP-IDF and has no Tcl/Tk.
